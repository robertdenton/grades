...
<html>
	...
	<body id="dt_example">
		<div id="container">
			...
			<p>Below, is a searchable, sortable representation of every class at CU during the spring 2013 and fall 2013 semesters and each's grade distribution. In other words, what percent of the class got an A, B, C or D/F.</p>
			<p>All of the data, and more, is publically accessible through the <a href="www.colorado.edu/pba/‎">CU Office of Planning and Budget Analysis</a> <a href="www.colorado.edu/pba/course/gradesintro.htm">here</a>.</p>
			<p><b>Note: This is a considerable amound of data, please give it a second to fully load.</b></p>
			<div id="demo">
